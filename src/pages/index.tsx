  ...
  return (
    <main style={styles.pageStyles}>
      <h1 style={styles.headingStyles}>
        Congratulations
        <br />
        <span style={styles.headingAccentStyles}>— you just made a Gatsby site! 🎉🎉🎉</span>
      </h1>
      <p style={styles.paragraphStyles}>
        Edit <code style={styles.codeStyles}>src/pages/index.tsx</code> to see this page
        update in real-time. 😎
      </p>
      <ul style={styles.doclistStyles}>
        {docLinks.map(doc => (
          <li key={doc.url} style={styles.docLinkStyle}>
            <a
